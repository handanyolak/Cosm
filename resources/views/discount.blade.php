            ...
            <div class="container">
                <nav data-depth="3" class="breadcrumb">
                    <ol>
                        ...
                        <li><a href="#"><span>Kampanya </span></a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
{{--                                                    <div class="manufacturer">
                                                    ...
                                                    <div class="product-price-and-shipping">
                                                        <span class="regular-price">{{ $product->price }}0 TL</span>
                                                        <span class="price price-sale">{!! $product->price - ($product->price*40)/100  !!} TL</span>
                                                    </div>
                                                    <div class="cart">
