            ...
            <div class="container">
                <nav data-depth="3" class="breadcrumb">
                    <ol>
                        ...
                        <li><a href=""><span class="text-uppercase">{{ Request::segment(2) }}</span></a>
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="col-xs-12 col-md-9 shop-content" style="margin-left: auto; margin-right: auto;">
                    <div class="product-toolbar">
                        <div class="topbar-title">
                            <h1 class="text-uppercase">{{ Request::segment(2) }}</h1>
                        </div>
...
{{--                                                    <div class="manufacturer">
                                                    ...
                                                    <h1><a href="{{ route('product.show',$product) }}" class="product_name" title="Hummingbird printed t-shirt">{{ $product->name }}</a></h1>
